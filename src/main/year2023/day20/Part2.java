...
public class Part2 {
    ...
    private static final AtomicInteger buttonPresses = new AtomicInteger();
    private static final AtomicBoolean done = new AtomicBoolean(false);
    private static final AtomicInteger buttonPressesRequired = new AtomicInteger();
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(buttonPressesRequired.get());
    }
    ...
    private static class Transmission {
        ...
        public Transmission(Transmitter source, Transmitter destination, boolean signal) {
            ...
            if (!signal && destination.getId().equals("rx")) {
                done.set(true);
                buttonPressesRequired.set(buttonPresses.get());
            }
        }
